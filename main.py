...
def qr_code_generator(
    file: TXTFileType, box_size: int, border: int, image_factory, out_folder
):
...
def main(argv=sys.argv[1:]):
    ...
    parser.add_argument("--out_folder", default="images", type=str, help="")
    args = parser.parse_args(argv)
    try:
        qr_code_generator(
            args.file, args.box_size, args.border, args.image_factory, args.out_folder
        )
    finally:
